...
// event.preventDefault();
	...
	$('#of-nav li a').click(function(){
		...
		return false;
		  ...
		  //importColors
    $(".color_schema_link_list").click(function(e){
     
    // alert("hi");
		    e.preventDefault();
		    var answer = confirm("Click OK to Import Color Schema Settings.")
		...
		if (answer){
			...
			var data = {
				...
				type: 'import_schema_options',
				schema_id :clickedID.replace("color_scheme_",""),
				security: nonce
			};
...
//                            if (elm.attr("type") == 'text' || elm.attr("type") == 'hidden' || elm.is("select"))
                            {
...
//                                           ipnone_checkbox.attr('checked', false);                                        
                                        ipnone_checkbox.removeAttr('checked');
                                    }
...
//                                  console.log("counter" + j);
           ...
           // input#of-radio-tile-oxy_body_bg279.checkbox               
                //var names =  [$("#of-radio-tile-"+i + j),$("#of-radio-img-"+i + j)];
                                ...
                                //of-radio-img-oxy_general_icons_style1
                                //checkbox of-radio-img-radio
	...
	return false;
        ...
        $('#of_form_theme_texts').submit(function(){
            var formdataArr = $(this).serializeArray();            
            var formdata = $(this).serialize();
            var security,tab_page = '';
            
            $.each(formdataArr,function(k,v){
                if(v.name == 'security'){
                    security = v.value;
                }else if(v.name == 'tab_page'){
                    tab_page = v.value;
                }
            });
