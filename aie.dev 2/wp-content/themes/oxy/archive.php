            ...
            <?php if ( have_posts() ) :         
                    ...
                    ?>
                            ...
                            <h1 class="archive-title"><?php
                                            if ( is_day() ) :
                                                    printf( __( 'Daily Archives: %s', 'oxy' ), get_the_date() );

                                            elseif ( is_month() ) :
                                                    printf( __( 'Monthly Archives: %s', 'oxy' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'oxy' ) ) );

                                            elseif ( is_year() ) :
                                                    printf( __( 'Yearly Archives: %s', 'oxy' ), get_the_date( _x( 'Y', 'yearly archives date format', 'oxy' ) ) );
